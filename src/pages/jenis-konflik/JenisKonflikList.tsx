...
export default function JenisKonflikList() {
  ...
  const handleDelete = (id: string, nama: string) => {
    if (!confirm(`Apakah Anda yakin ingin menghapus jenis konflik "${nama}"?`)) return;
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between gap-3">
          <h2 className="text-base font-semibold text-gray-800 dark:text-white/90">
            Master Data Jenis Konflik
          </h2>
          <Button size="sm" onClick={() => navigate("/jenis-konflik/create")} className="gap-1.5">
            <PlusIcon /> Tambah
          </Button>
        </div>
