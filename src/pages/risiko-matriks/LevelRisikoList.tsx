...
export default function LevelRisikoList() {
  ...
  const [data, setData] = useState<LevelRisiko[]>(mockLevelRisiko);
    ...
    },
    {
      ...
      render: (item) => (
        <div className="flex items-center gap-2">
          <span className="inline-block w-6 h-6 rounded-md border border-gray-200 dark:border-gray-700 shadow-sm"
    ...
    <>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <Button size="sm" onClick={() => navigate("/risiko/level/create")} className="gap-1.5">
            <PlusIcon /> Tambah
          </Button>
        </div>
